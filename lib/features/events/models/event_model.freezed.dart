...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,description,eventDate,paymentDeadline,amountPerParticipant,transferAlias,cvu,accountHolder,instructions,isActive,slug,publicToken,createdBy,createdAt,updatedAt);

@override
String toString() {
  return 'EventModel(id: $id, title: $title, description: $description, eventDate: $eventDate, paymentDeadline: $paymentDeadline, amountPerParticipant: $amountPerParticipant, transferAlias: $transferAlias, cvu: $cvu, accountHolder: $accountHolder, instructions: $instructions, isActive: $isActive, slug: $slug, publicToken: $publicToken, createdBy: $createdBy, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
switch (_that) {
case _EventModel() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.eventDate,_that.paymentDeadline,_that.amountPerParticipant,_that.transferAlias,_that.cvu,_that.accountHolder,_that.instructions,_that.isActive,_that.slug,_that.publicToken,_that.createdBy,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
switch (_that) {
case _EventModel():
return $default(_that.id,_that.title,_that.description,_that.eventDate,_that.paymentDeadline,_that.amountPerParticipant,_that.transferAlias,_that.cvu,_that.accountHolder,_that.instructions,_that.isActive,_that.slug,_that.publicToken,_that.createdBy,_that.createdAt,_that.updatedAt);}
}
...
class _EventModel implements EventModel {
  const _EventModel({required this.id, required this.title, required this.description, @TimestampConverter() required this.eventDate, @TimestampConverter() required this.paymentDeadline, required this.amountPerParticipant, required this.transferAlias, this.cvu, required this.accountHolder, required this.instructions, required this.isActive, required this.slug, this.publicToken, required this.createdBy, @TimestampConverter() required this.createdAt, @TimestampConverter() required this.updatedAt});
